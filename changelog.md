# Changelog
## 0.7.0
* Update to egui 0.34.0.
* Raise MSRV to 1.92 (this matches egui's MSRV).

note: published as 0.7.0 because I accidentally published (and yanked) 0.6.0
...
* Raise MSRV to 1.85.0 (this matches egui's MSRV).
